...
error_reporting(E_ERROR);
	...
	class Geo
    {
        ...
        function get_geobase_data()
        {
            ...
            $link = 'geoip.leadia.ru/get?format=raw&ip='.$this->ip;
            #$link = 'http://geoip.leadia.ru/get?format=raw&ip=217.118.79.43';
            $ch = curl_init();
...
#
    ...
    #    $region = $data['city'];
    #}elseif( isset( $data['region'] ) && !empty( $data['region'] ) ){
    #    $region = $data['region'];
    #}elseif($data['country'] == "MD") {
    #    $region = "Молдова";
    #}

    #echo $region;

    #$region = iconv("cp1251", "utf-8", $region);
